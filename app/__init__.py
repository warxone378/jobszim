...
def create_app():
    ...
    # Import all blueprints (excluding chat)
    from app.routes import job_routes, auth_routes, admin_routes, contact_routes, saved_routes, application_routes, alert_routes, password_routes, review_routes, company_routes, seo_routes, twofa_routes
    ...
    with app.app_context():
        ...
        # Add company fields if not exists
